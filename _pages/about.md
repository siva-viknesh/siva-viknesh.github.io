...
<div style="text-align: justify;">
  <p>👨🏻‍🎓 <strong>PhD Candidate</strong> in the Scientific Computing & Imaging (SCI) Institute and the Department of Mechanical Engineering at the University of Utah, advised by <strong>Dr. Amirhossein Arzani</strong>. I am passionate about <strong>Fluid Mechanics</strong> and <strong>Scientific Machine Learning</strong>, developing <strong>Hybrid Physics–AI frameworks</strong> that integrate physics principles with data-driven methods to solve complex spatio-temporal flow problems. Specifically, my research interest spans:</p> <ul> <li><strong>Aerodynamics/Fluid Mechanics:</strong> Uncovering and understanding the fundamental flow physics.</li> <li><strong>Differentiable PDE solvers:</strong> Using AI methods to accelerate computational simulations.</li> <li><strong>Differentiable AI methods:</strong> Incorporate physical priors into AI models, making them both interpretable and physically consistent.</li> </ul> <p>I always look for solving real-world engineering problems, moving beyond academic exercises, and developing solutions that are both scientifically rigorous and practically impactful.</p>
