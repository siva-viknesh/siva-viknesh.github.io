...
<p>🔬 Research interests span around:</p><ul>
    <li><strong>Fluid Mechanics:</strong> Uncovering and understanding the fundamental flow physics, particularly, <strong>Aerodynamics</strong>.</li>
    <li><strong>Differentiable PDE solvers:</strong> Using AI methods to accelerate computational simulations.</li>
    <li><strong>Differentiable AI methods:</strong> Incorporate physical priors into AI models, making them both interpretable and physically consistent.</li>
  </ul><p>👨🏻‍🔬 I always look for solving real-world engineering problems, moving beyond academic exercises, and developing solutions that are both scientifically rigorous and practically impactful.</p>
