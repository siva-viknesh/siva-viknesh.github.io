...
<p>🎓 <strong>Educational Background:</strong>  
  I hold an <span style="color: #1E90FF;">M.S. in Aerospace Engineering with Aerodynamics major</span> from <strong>IIT Kanpur</strong>, India, where I focused on both Computational Fluid Mechanics and Wind Tunnel Measurements, and a <span style="color: #1E90FF;">B.E. in Aeronautical Engineering</span> from <strong>Anna University</strong>, Tamil Nadu, India, where I developed a strong interest in Aerodynamics and solving PDEs.</p>
</div>
